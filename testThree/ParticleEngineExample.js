...
Examples =
{
	...
	{
		positionStyle    : Type.CUBE,
		positionBase     : new THREE.Vector3( 0, -80, 0 ), // y = 0
		positionSpread   : new THREE.Vector3( 10, 0, 10 ),
	...
	{
		positionStyle  : Type.CUBE,
		positionBase   : new THREE.Vector3( 0, 170,  0 ), // x=-100 y=100
		positionSpread : new THREE.Vector3( 10, 25, 60 ), // y = 50
		
		velocityStyle  : Type.CUBE,
		velocityBase   : new THREE.Vector3( 40, -15, -20 ), // 40 0 0 
		velocitySpread : new THREE.Vector3( 1000, 0, 0 ), //x=20 0 0 
