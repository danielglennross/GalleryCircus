				...
				<div id="leftNav">
					...
					<div id="pageLinks">
						<ul>
							...
							<li class="linkElement"><a id="linkMedia" href="#TrackTheStorm" class="shakeable">play</a></li>
							<li class="linkElement"><a id="linkMedia" href="/shows" class="shakeable" target="_blank">shows</a></li>
